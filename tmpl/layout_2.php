...
<style>
<?php echo $css; ?>
.show_on_action_unwetter {display:none !important;}
...
foreach ($arr as $k=>$v){
			...
			if ($level == '4' or $level == '5') :	
				 ...
				 //echo $regionName.' = '.$headline.'<br/>';
					...
					if ($level == '4' or $level == '5') :	
					echo '<style>.show_on_action_unwetter {display:inline !important;}.hide_on_action_unwetter {display:none !important;}</style>';			 
					endif;
			endif;
}	
endif;
